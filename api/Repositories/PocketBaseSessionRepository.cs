...
{
    public class PocketBaseSessionRepository : IGameSessionRepository
    {
        private readonly PocketBaseService _pb;

        public PocketBaseSessionRepository(PocketBaseService pb)
        {
            _pb = pb;
        }
        ...
        public async Task<IEnumerable<GameSession>> GetByUserIdAsync(string userId)
        {
            ...
            return response?.Items ?? new List<GameSession>();
        }

...
namespace Bikeapelago.Api.Services
{
    ...
    public class OverpassService
    {
        ...
        public OverpassService(HttpClient httpClient, Microsoft.Extensions.Configuration.IConfiguration configuration)
        {
            _httpClient = httpClient;
            _overpassUrl = configuration["OverpassUrl"] ?? "https://overpass-api.de/api/interpreter";
        }

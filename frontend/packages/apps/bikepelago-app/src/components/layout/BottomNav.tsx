import { Home, Map, MessageSquare, Package } from 'lucide-react';
      ...
      <div className='mx-auto flex max-w-lg items-center justify-around px-6 pt-2 pb-2'>
        {isGamePage ? (
          <>
            <Link
              to='/'
              className='flex flex-col items-center gap-1 p-2 text-[var(--color-text-muted-hex)] transition-colors hover:text-[var(--color-primary-hex)]'
            >
          ...
          <>
            <Link
              to='/'
              className={`flex flex-col items-center gap-1 p-2 transition-colors ${pathname === '/' ? 'text-[var(--color-primary-hex)]' : 'text-[var(--color-text-muted-hex)] hover:text-[var(--color-primary-hex)]'}`}
            >
              <Home className='w-5 h-5' />
              <span className='text-[10px] font-bold uppercase tracking-wider'>
                Home
            ...
            <Link
              to='/new-game'
              className={`flex flex-col items-center gap-1 p-2 transition-colors ${pathname.startsWith('/new-game') ? 'text-[var(--color-primary-hex)]' : 'text-[var(--color-text-muted-hex)] hover:text-[var(--color-primary-hex)]'}`}
            >
              <svg
            ...
            <Link
              to='/yaml-creator'
              className={`flex flex-col items-center gap-1 p-2 transition-colors ${pathname === '/yaml-creator' ? 'text-[var(--color-primary-hex)]' : 'text-[var(--color-text-muted-hex)] hover:text-[var(--color-primary-hex)]'}`}
            >
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width='20'
            ...
            <Link
              to='/settings'
              className={`flex flex-col items-center gap-1 p-2 transition-colors ${pathname === '/settings' ? 'text-[var(--color-primary-hex)]' : 'text-[var(--color-text-muted-hex)] hover:text-[var(--color-primary-hex)]'}`}
            >
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width='20'

      ...
      <div className='p-4 border-t border-[var(--color-border-hex)] bg-[var(--color-surface-hex)]/20'>
        <form onSubmit={handleSendMessage} className='relative flex gap-2'>
          ...
          <button
            ...
            className='w-10 h-10 bg-[var(--color-primary-hex)] hover:bg-[var(--color-primary-hover-hex)] disabled:opacity-30 disabled:bg-[var(--color-surface-alt-hex)] rounded-xl flex items-center justify-center transition-all shadow-lg active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary-hex)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-surface-hex)]'
          >

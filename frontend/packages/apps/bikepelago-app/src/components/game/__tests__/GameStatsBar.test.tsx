  ...
  const mockNodes: MapNode[] = [
    {
      ...
      lon: -70,
      state: 'Checked',
      is_arrival_checked: true,
      is_precision_checked: true,
    ...
    },
    {
      ...
      ap_arrival_location_id: 3,
      ap_precision_location_id: 4,
      region_tag: 'Hub',
      has_been_relocated: false,
    },
    {
      ...
      is_arrival_checked: false,
      is_precision_checked: false,
      ap_arrival_location_id: 5,
      ap_precision_location_id: 6,
      region_tag: 'Hub',
      has_been_relocated: false,
    },
    {
      ...
      is_arrival_checked: false,
      is_precision_checked: false,
      ap_arrival_location_id: 7,
      ap_precision_location_id: 8,
      region_tag: 'Hub',
      has_been_relocated: false,
    },
  ];

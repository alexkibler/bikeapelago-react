...
const RoutePanel = ({ sessionId }: { sessionId: string }) => {
  ...
  // ⚡ Bolt: Single Pass Node Categorization
  // What: Combine 3 filter passes over nodes into a single O(N) useMemo block.
  // Why: Previous logic looped over nodes 3 times on every render.
  // Impact: Reduces main-thread blocking UI work by removing duplicate iterations.

...
// ⚡ Bolt: Prevent unnecessary synchronous JSON parsing overhead.
// Passing the coordinates array directly avoids blocking the main thread
// with large JSON.stringify -> JSON.parse roundtrips during GPX generation.

    ...
    <div className='max-w-4xl mx-auto py-12 px-6'>
      <header className='mb-12 text-center'>
        ...
        <p className='text-neutral-400 max-w-2xl mx-auto'>
          Generate the necessary files to host your own Bikeapelago multiworld
          session.
        </p>
      </header>
        ...
        <div className='space-y-8'>
          <div className='bg-neutral-900 border border-neutral-800 rounded-3xl p-8 shadow-xl'>
            ...
            <p className='text-sm text-neutral-400 mb-6 leading-relaxed'>
              Download the game definition file and place it in your Archipelago
              server's <code>lib/worlds</code> directory.
            </p>
          ...
          <div className='bg-orange-500/5 border border-orange-500/10 rounded-3xl p-8'>
            <div className='flex items-center gap-4 mb-6'>
              <div className='w-10 h-10 rounded-xl bg-orange-600/20 flex items-center justify-center font-black text-orange-500'>
                3
              </div>
      ...
      <div className='mt-12 p-6 bg-neutral-900/50 rounded-2xl border border-neutral-800 flex items-start gap-4'>
        ...
        <p className='text-xs text-neutral-500 leading-relaxed'>
          The YAML file contains your player preferences, while the APWorld file
          tells Archipelago how Bikeapelago works. Both are essential for a
          successful multiworld generation. Once generated, use the connection
          info to join a session on the Home screen.
        </p>
      </div>
    </div>
  );

...
const GameView = () => {
  ...
  // ⚡ Bolt: Memoize expensive JSON.parse and map operations for polyline rendering
  // Why: Prevents blocking the main thread during component re-renders
  ...
  // ⚡ Bolt: Memoize path mapping array transformation
  // Why: Avoids recreating large arrays and objects on every render

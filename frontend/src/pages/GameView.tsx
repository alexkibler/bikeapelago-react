...
const GameView = () => {
  ...
  // ⚡ Bolt: Memoize expensive JSON parsing and array mapping of large route data to prevent main-thread blocking during re-renders
  ...
  // ⚡ Bolt: Memoize expensive parsing of analysis path

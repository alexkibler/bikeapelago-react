...
import { User, Lock, Trash2, AlertTriangle, Check, Loader2, ShieldAlert, Save, ArrowLeft } from 'lucide-react';
                        ...
                        <div className="shrink-0">
                            ...
                            {deleteStep === 1 && (
                                <div className="flex flex-col items-center gap-3 animate-in fade-in zoom-in-95 duration-200">
                                    <p className="text-red-500 text-[10px] font-black uppercase tracking-[0.2em] animate-pulse">Are you absolutely sure?</p>
                            ...
                            {deleteStep === 2 && (
                                <div className="flex flex-col items-center gap-3 animate-in fade-in zoom-in-95 duration-200">
                                    <div className="flex items-center gap-2 text-red-500 mb-1">
                                        ...
                                        <p className="text-[10px] font-black uppercase tracking-[0.2em]">Final Confirmation Required</p>
                                    </div>
                                    <div className="flex gap-2">
                                        <button 
                                            onClick={() => setDeleteStep(0)}
                                        ...
                                        >
                                            {isDeletingAll ? <Loader2 className="w-4 h-4 animate-spin" /> : <ShieldAlert className="w-4 h-4" />}

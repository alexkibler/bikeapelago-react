...
import { Bike, Lock, User, ArrowRight, Loader2, Mail, UserPlus } from 'lucide-react';
    ...
    <div className="min-h-[80vh] flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-black text-[var(--color-text-hex)] italic uppercase tracking-tighter mb-2">Join the Race</h1>
          <p className="text-[var(--color-text-subtle-hex)] font-medium">Create your Bikeapelago account</p>
        </div>
